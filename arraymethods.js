...
function replaceEmailadress(arrayOfEmailadresses, oldEmailadress, newEmailadress) {
    index = emailadresses.indexOf(oldEmailadress)
    if (emailadresses.includes(oldEmailadress)) {
        emailadresses.splice(index, 1, newEmailadress)
    }
    return emailadresses
}

console.log(replaceEmailadress(emailadresses, "m.vandergeest@novi-education.nl", "m.vandergeest@novi.nl"))